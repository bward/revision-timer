...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(1);
const TaskList_1 = __webpack_require__(9);
var ReactHowler = __webpack_require__(10);
    ...
    render() {
        return (React.createElement("div", { className: "container" },
            ...
            this.state.shouldPlaySound ?
                React.createElement(ReactHowler, { src: './zen_temple_bell.mp3', onEnd: () => this.setState({ shouldPlaySound: false }) })
                : null));
    }
}
...
class TaskList extends React.Component {
    ...
    renderTask(item, key) {
        ...
        return (React.createElement("div", { key: key, className: key == this.state.currentItem ? divClass + " active" : divClass },
            React.createElement("div", { className: "col" }, item),
            React.createElement("div", { className: "col" },
                React.createElement("button", { type: "button", className: "close", value: key, onClick: this.handleDelete }, "\u00D7"))));
    }
    render() {
...
var _howler4 = __webpack_require__(16);
